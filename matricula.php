...
$VLQry27=" SELECT p.perapellidos, p.pernombres, p.percc, p.perfechanacimiento, ie.inescodigo, m.mtrno, m.mtrfolio, m.mtrfecha, m.grucodigo, m.mtrestado, m.anocodigo ";
$VLQry27.=" FROM psn p, nsttcnstdnt ie, mtrcl m  ";
$VLQry27.=" WHERE p.percodigo = ie.percodigo and ie.inesestado=1 and ie.inescodigo=m.inescodigo ";
...
if ( $VLnuDatos>0 )
{
	...
	$VLFolio=get_result($VLdtDatos,0,"anoinicio");
}
...
<title>Pantalla de Administracion del Sistema - Matrícula</title></head>
<body>
<?php 
...
if($VLnuDatosU>0){
include("sallitnalp/strctr1scrmtrcl.php"); 
} else{
