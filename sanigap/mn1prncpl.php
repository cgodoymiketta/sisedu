...
<table width="1000" border="0">
  ...
  <tr>
    <td><strong><font size="2" face="Times New Roman, Times, serif"><?php echo $VLdtPeriodo; ?><input type="hidden" name="sr" value="<?php echo $VLUsuario; ?>"></font></strong></td>
  </tr>
</table>
		</td>
        <td width="62%" align="center" valign="middle">Principal</td>
        <?php 
					$VTReporte=0;
					$VTDocente=0;
					$VTSecretaria=0;
