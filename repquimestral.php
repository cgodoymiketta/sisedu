...
$VLtxtCampo3="Materias";
$VLtxtCampo4="Curso/Paralelo";
$VLtxtCampo5="Curso";
$VLtxtCampo8="Activar";
...
<head><title>Reportes - Calificacion Quimestral</title></head>
<body>
<?php 
...
if($VLnuDatosU>0){
	include("sallitnalp/strctr1rprtqmstrl.php"); 
} else{
