...
$VLQry7=" order by f.famnombre, m.matdescripcion ";
$VLQry8=" Update dcntmtr set ";
$VLQry9=" Insert into dcntmtr ( indocodigo, matcodigo, famcodigo, dcmtestado ) values (";
$VLQry10= "SELECT c.cursigla, c.curorden, p.pardescripcion, p.parorden, e.espdescripcion, e.espcodigo  ";
...
$VLQry10.= " order by c.curorden, p.parorden ";
...
<head><title>Pantalla de Administracion del Sistema - Docente Materia</title></head>
<body>
<?php 
...
if($VLnuDatosU>0){
	include("sallitnalp/strctr1scrdcntmtr.php"); 
} else{
