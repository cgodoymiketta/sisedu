<table width="100%" border="0">
	<tr>
	  ...
	  <td width="10%"><? if ( $VLNuevo == "kk"){ ?><input name="guardar" type="image" id="guardar" onClick="sumit" src="imagenes/Floppy%20Disk%20Blue_24x24-322.gif" alt="Guardar" width="24" height="24" border="0" value="guardar"><? } ?></td>
