	...
	if ( $VLConsultar!="")
	{
		...
		if ( $VLnuDatos>0 )
		{
			for ( $i=0; $i< $VLnuDatos; $i++  )
			{
				...
				$VTTablaLista.="<td width='80' ><a href='seccurso.php?vlccn=modificar&txt_Camp1=".$VTCampo1."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".$VTCampo3."</font></strong></a></td>";
			}
		}
		  $VTTablaLista.="</tr>";
					...
					for ( $i=0; $i< $VLnuDatos; $i++  )
					{
						...
						if ($VLnuDatos3==0)
						{
							...
							if ($activo=="no")
							{
								...
								$VTTablaLista.="<td width='80' ><font face='Times New Roman, Times, serif' size='2' color='#000000' ><img src='imagenes/blog-post-accept_16x16-32.gif' alt='Si' width='16' height='16' border='0'></font></strong></td>";
							}
						}
					}
				}
