...
<?php 
	...
	if ( $VLnuDatos>0 )
	{
		for ( $i=0; $i< $VLnuDatos; $i++  )
		{
		  ...
		  $VTTablaLista.="<tr>";
			$VTTablaLista.="<td ><a href='vicparcial.php?vlccn=modificar&txt_Camp1=".$VTCampo1."&txt_Camp6=".$VTCampo6."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".$VTCampo8."</font></strong></a></td>";
			$VTTablaLista.="<td ><a href='vicparcial.php?vlccn=modificar&txt_Camp1=".$VTCampo1."&txt_Camp6=".$VTCampo6."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".$VTCampo1."</font></strong></a></td>";
			$VTTablaLista.="<td ><a href='vicparcial.php?vlccn=modificar&txt_Camp1=".$VTCampo1."&txt_Camp6=".$VTCampo6."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".$VTCampo2."</font></strong></a></td>";
			$VTTablaLista.="<td ><a href='vicparcial.php?vlccn=modificar&txt_Camp1=".$VTCampo1."&txt_Camp6=".$VTCampo6."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".$VTCampo13."</font></strong></a></td>";
			$VTTablaLista.="<td ><a href='vicparcial.php?vlccn=modificar&txt_Camp1=".$VTCampo1."&txt_Camp6=".$VTCampo6."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".$estado."</font></strong></a></td>";
			$VTTablaLista.="<td ><a href='vicparcial.php?vlccn=modificar&txt_Camp1=".$VTCampo1."&txt_Camp6=".$VTCampo6."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".$VTCampo4."</font></strong></a></td>";
			$VTTablaLista.="<td ><a href='vicparcial.php?vlccn=modificar&txt_Camp1=".$VTCampo1."&txt_Camp6=".$VTCampo6."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".$VTCampo5."</font></strong></a></td>";
		  $VTTablaLista.="</tr>";
		}
	} else {
