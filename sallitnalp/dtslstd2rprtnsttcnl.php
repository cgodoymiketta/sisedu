...
if ($VLdtCamp19!="" && $VLConsultar4=="1"){ //// tenemos un alumno
	...
	$VTCampo27=get_result($VLdtDatosR,0,$VLQryCampo27);
...
<?php 
		...
		/* Determinamos las columnas que va a tener la tabla */
				...
				$VTTablaLista.="<td width='350' align='center' ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".$VLtxtCampo12."</font></strong></td>";
				...
				$VTTablaLista.="<td width='100' align='center' ><font face='Times New Roman, Times, serif' size='2' color='#000000' >Periodo</font></strong></td>";
		  $VTTablaLista.="</tr>";
		...
		if ( $VLnuDatos>0 )
		{
			for ( $j=0; $j< $VLnuDatos; $j++  )
			{
				...
				$VTPeriodo=get_result($VLdtDatos,$j,$VLQryCampo28);
				$VTCampo29=get_result($VLdtDatos,$j,$VLQryCampo29);
				...
				if ( $VLdtCriterio2=="NUEVOS" && $VTCampo16!="")
				{
					...
					//}else{
				$VTTablaLista.="<tr>";
				$VTTablaLista.="<tr><td width='80' ><a href='repestudiantegeneral.php?vlccn=modificar&critero2=".$VLdtCriterio2."&txt_Camp1=".$VLdtCamp1."&nsttcn=".$VLInstitucion."&nlctv=".$VLAnoLocal."&sr=".$VLUsuario."&txt_Camp14=".$VLdtCamp14."&txt_Camp11=".$VTCampo11."&txt_Camp19=".$VTCampo19."&txt_Camp16=".$VTCampo16."&txt_Camp25=".$VTCampo25."&txt_Camp29=".$VTCampo29."&txt_Camp17=".$VTCampo17."&consultar4=1' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".$VTCampo19."</font></strong></a></td>";
				$VTTablaLista.="<td width='80' ><a href='repestudiantegeneral.php?vlccn=modificar&critero2=".$VLdtCriterio2."&txt_Camp1=".$VLdtCamp1."&nsttcn=".$VLInstitucion."&nlctv=".$VLAnoLocal."&sr=".$VLUsuario."&txt_Camp14=".$VLdtCamp14."&txt_Camp11=".$VTCampo11."&txt_Camp19=".$VTCampo19."&txt_Camp16=".$VTCampo16."&txt_Camp25=".$VTCampo25."&txt_Camp29=".$VTCampo29."&txt_Camp17=".$VTCampo17."&consultar4=1' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".$VTCampo22." ".$VTCampo21."</font></strong></a></td>";
				$VTTablaLista.="<td width='80' align='center' ><a href='repestudiantegeneral.php?vlccn=modificar&critero2=".$VLdtCriterio2."&txt_Camp1=".$VLdtCamp1."&nsttcn=".$VLInstitucion."&nlctv=".$VLAnoLocal."&sr=".$VLUsuario."&txt_Camp14=".$VLdtCamp14."&txt_Camp11=".$VTCampo11."&txt_Camp19=".$VTCampo19."&txt_Camp16=".$VTCampo16."&txt_Camp25=".$VTCampo25."&txt_Camp29=".$VTCampo29."&txt_Camp17=".$VTCampo17."&consultar4=1' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".$VTCampo16."/".$VTCampo17."</font></strong></a></td>";
				////////// ponemos al año lectivo
				$VTTablaLista.="<td width='80' align='center' ><a href='repestudiantegeneral.php?vlccn=modificar&critero2=".$VLdtCriterio2."&txt_Camp1=".$VLdtCamp1."&nsttcn=".$VLInstitucion."&nlctv=".$VLAnoLocal."&sr=".$VLUsuario."&txt_Camp14=".$VLdtCamp14."&txt_Camp11=".$VTCampo11."&txt_Camp19=".$VTCampo19."&txt_Camp16=".$VTCampo16."&txt_Camp25=".$VTCampo25."&txt_Camp29=".$VTCampo29."&txt_Camp17=".$VTCampo17."&consultar4=1' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".$VTPeriodo."</font></strong></a></td>";
				$VTTablaLista.="</tr>";
...
<!-----------------------------------  Hasta aqui va la visualización del listado  ----------------------------------------------->
  ...
  <tr>
    <td width="20%">&nbsp;</td>
    <td width="60%" align="center">REPORTES</td>
    <td width="20%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><a href="repacumulativogeneral.php?nlctv=<?=$VLAnoLocal; ?>&nsttcn=<?=$VLInstitucion; ?>&txt_Camp1=<?=$VTCampo27; ?>&nlctv2=<?=$VLdtCamp29; ?>"  target="_blank">Registro acumulativo general</a></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><a href="repmatriculareglamentaria.php?nlctv=<?=$VLAnoLocal; ?>&nsttcn=<?=$VLInstitucion; ?>&txt_Camp1=<?=$VLdtCamp16; ?>&nlctv2=<?=$VLdtCamp29; ?>"  target="_blank">Matricula Reglamentaria</a></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><a href="repcontrolcomportamiento.php?nlctv=<?=$VLAnoLocal; ?>&nsttcn=<?=$VLInstitucion; ?>&txt_Camp1=<?=$VLdtCamp16; ?>&nlctv2=<?=$VLdtCamp29; ?>"  target="_blank">Control de Faltas al Comportamiento</a></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><a href="repfichatutor_pastoral.php?nlctv=<?=$VLAnoLocal; ?>&nsttcn=<?=$VLInstitucion; ?>&txt_Camp1=<?=$VLdtCamp16; ?>&nlctv2=<?=$VLdtCamp29; ?>"  target="_blank">Ficha del Tutor y Pastoral</a></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><a href="setroper/repcertificadomatricula.php?nlctv=<?=$VLAnoLocal; ?>&nsttcn=<?=$VLInstitucion; ?>&txt_Camp1=<?=$VLdtCamp16; ?>&nlctv2=<?=$VLdtCamp29; ?>"  target="_blank">Certificado de Matricula</a></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><a href="setroper/repcertificadodepromocionunitario.php?nlctv=<?=$VLAnoLocal; ?>&amp;nsttcn=<?=$VLInstitucion; ?>&amp;txt_Camp10=<?=$VLdtCamp16; ?>&nlctv2=<?=$VLdtCamp29; ?>"  target="_blank">Certificado de Promocion</a></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><a href="setroper/repcertificadodecomportamientounitario.php?nlctv=<?=$VLAnoLocal; ?>&amp;nsttcn=<?=$VLInstitucion; ?>&amp;txt_Camp10=<?=$VLdtCamp16; ?>&nlctv2=<?=$VLdtCamp29; ?>"  target="_blank">Certificado de Comportamiento</a></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
