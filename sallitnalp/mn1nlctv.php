...
<table width="1000" border="0">
  ...
  <tr>
    <td><strong><font size="2" face="Times New Roman, Times, serif"><?php echo $VLdtPeriodo; ?><input type="hidden" name="nlctv" value="<?php echo $VLAnoLocal; ?>"><input type="hidden" name="nsttcn" value="<?php echo $VLInstitucion; ?>"><input type="hidden" name="sr" value="<?php echo $VLUsuario; ?>"></font></strong></td>
        ...
        <td width="62%" align="center" valign="middle">A&ntilde;o Lectivo</td>
        <?php 
					$VTReporte=0;
					$VTDocente=0;
					$VTSecretaria=0;
        ...
        <td width="6%"><a href="index.php?nlctv=<?php echo $VLAnoLocal; ?>&nsttcn=<?php echo $VLInstitucion; ?>&sr=<?php echo $VLUsuario; ?>"><img src="imagenes/Home_48x48-32.gif" alt="Inicio" width="48" height="48" border="0"></a></td>      </tr>
    </table></td>
    <td width="50">&nbsp;</td>
  </tr>
</table>
