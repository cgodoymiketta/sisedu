...
case "guardar":
	...
	{
		$Vtquery = $VLQry1."'$VLdtCamp2','$VLdtCamp3','$VLdtCamp5',1,'$VLdtCamp4','$VLdtCamp7','$VLInstitucion'".$VLQry5;
		//echo $Vtquery;
...
<table width="100%"  border="0">
	<tr>
	  <td ><?php include("mnuccnspcldd.php"); ?></td>
	</tr>
	  <tr>
		<td ><hr></td>
	  </tr>
	  <tr>
		...
		{
			include("dtslstd2spcldd.php"); 
		} else {
		 	include("dtslstd1spcldd.php"); 
		 }
		 ?></td>
	</tr>
</table>