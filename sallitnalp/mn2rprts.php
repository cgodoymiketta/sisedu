<table width="100%" border="0">
					...
					<td width="85%"  align="left"><strong><font face="Times New Roman, Times, serif" size="2" color="#0000FF" > Materia</font></strong></td>
					  ...
					  <tr>
						<td width="85%"  align="left"><p><a href="replibreta.php?vlccn=listado&amp;nlctv=<?php echo $VLAnoLocal; ?>&amp;nsttcn=<?php echo $VLInstitucion; ?>&amp;sr=<?php echo $VLUsuario; ?>"><strong><font face="Times New Roman, Times, serif" size="2" color="#990000" >Reportes Parcial</font></strong></a></p></td>
					  </tr>
					  <tr>
						<td width="85%"  align="left"><a href="replibretaq.php?vlccn=listado&nlctv=<?php echo $VLAnoLocal; ?>&nsttcn=<?php echo $VLInstitucion; ?>&sr=<?php echo $VLUsuario; ?>"><strong><font face="Times New Roman, Times, serif" size="2" color="#990000" >Reporte Quimestral</font></strong></a> </td>
					  </tr>
					  <tr>
