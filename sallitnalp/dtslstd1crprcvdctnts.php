...
<?php } ?>
    ...
    <tr> <td colspan="3"> 		<?php
		...
		$Vtquery = $VLQry10.$VLQry9; 	////// CONSULTAMOS LA ESPECIALIDAD
		$Vtquery2 = $VLQry6;			////// COSNULTAMOS EL CURSO
...
/*
	if ( $VLConsultar!="")
	{
		...
		case $VLtxtCampo1:
			...
			$Vtquery .= " and ";
			$Vtquery3 .= " ".$VLQryCampo7." like '%".$VLdtConsultar."%' and ";
			break 1; 
		case $VLtxtCampo2:
	...
	*/
		$Vtquery .= $VLQryCampo7." in (";
		$Vtquery .= " select ".$VLQryCampo7." from ";
		$Vtquery .= $VLQry12.$VLQry9.$VLQryCampo10."=1 ".$VLQry5." ";
		$Vtquery .= $VLQry17;
		$Vtquery2 .= $VLQry11;
		$Vtquery3 .= $VLQryCampo17."=".$VLAnoLocal;
...
<?php 
		...
		$VTTablaLista="<table border='1'>";
		  $VTTablaLista.="<tr>";
				$VTTablaLista.="<td width='150' ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".($VLtxtCampo4)."</font></strong></td>";
		...
		if ( $VLnuDatos>0 )
		{
			...
			{
				$VTCampo1=get_result($VLdtDatos,$i,$VLQryCampo7);
				$VTCampo3=get_result($VLdtDatos,$i,$VLQryCampo13);
		...
		if ( $VLnuDatos2>0 )
		{
			...
			{
				$VTTablaLista.="<tr>";
				$VTCampo5=get_result($VLdtDatos2,$j,$VLQryCampo2);
				$VTCampo4=get_result($VLdtDatos2,$j,$VLQryCampo1);
					...
					for ( $i=0; $i< $VLnuDatos; $i++  )
					{
						...
						if ($VLnuDatos3==0)
						{
							...
							for($k=0; $k< $VLnuDatos3; $k++ )
							{
								...
								$VTCampo1a=get_result($VLdtDatos3,$k,$VLQryCampo7);
								$VTCampo4a=get_result($VLdtDatos3,$k,$VLQryCampo1);
							...
							$VLnuDatos4 = total_records($VLdtDatos4);
								...
								if($VLnuDatos4>0)
								{
									...
									for($y=0; $y<$VLnuDatos4; $y++)
									{
										...
										$VTTablaLista.="<td width='100' align='center'><a href='viccorrecionparcial.php?vlccn=parcial&txt_Camp1=".$VTCampo4."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."&txt_Camp7=".$VTCampo1."&txt_Camp15=".$VTCampo15."&txt_Camp19=".$VTCampo19."&critero2=Asignadas&consultar2.x=20&consultar2.y=15' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".($VTCampo20)."</font></strong></a></td>";
									}
