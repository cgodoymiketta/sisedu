							...
							$VLnuDatos4 = total_records($VLdtDatos4);
								...
								if($VLnuDatos4>0)
								{
									...
									for($y=0; $y<$VLnuDatos4; $y++)
									{
										...
										$VTTablaLista.="<td width='100' align='center'><a href='replibretaq.php?vlccn=reportes&txt_Camp1=".$VTCampo1."&txt_Camp9=".$VTCampo1."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."&txt_Camp4=".$VTCampo4."&txt_Camp15=".$VTCampo15."&txt_Camp19=".$VTCampo19."&critero2=Asignadas&consultar2.x=20&consultar2.y=15' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".$VTCampo20."</font></strong></a></td>";
									}
