...
order by p.perapellidos, p.pernombres";
	...
	if ( $VLnuDatos>0 )
	{
		for ( $i=0; $i< $VLnuDatos; $i++  )
		{
			...
			$VTQry="Select sum(dt.quipromparcial) injustificada, sum(dt.quiexamen) justificada, sum(dt.quiequivalencia20) atrasos, dt.matcodigo, dt.mtrno 
			from qmstr q, qmstrdtll dt 
			where q.quicodigo=dt.quicodigo
			and q.anocodigo=".$VLAnoLocal."
			and q.inscodigo=".$VLInstitucion."
			...
			if ( $VLnuDatosPro>0)
			{
				...
				for ($m=0; $m< $VLnuDatosPro; $m++)
				{
					...
					//{	
						...
						$VTdtInjustificada=+$VTdtInjustificadaa;
					//}
					//if ($VTdtExamen==0 )
					//{
						$VTdtJustificadaa=get_result($VLdtDatosPro,$m,"justificada");
						$VTdtJustificada=$VTdtJustificada+$VTdtJustificadaa;
					//}
					//if ($VTdtEquiv20==0 )		
					//{					
						$VTdtAtrasoa=get_result($VLdtDatosPro,$m,"atrasos");
						$VTdtAtraso= $VTdtAtrasoa+$VTdtAtraso;
					//}
				}
...
?>						  
    <tr>
        ...
        <input type="hidden" name="txt_Dtqmcodigo[]" value="<?php echo $VTdtDtqmcodigo; ?>"><input type="hidden" name="txt_dtmattipo[]" value="<?php echo $VtMateriaTipo; ?>"></font></td>
        <td width="10%" align="center">&nbsp;</td>
        <td width="10%" align="center"><input name="txt_PromParc[]" type="text" id="txt_PromParc" size="5" maxlength="5" value="<?php echo $VTdtInjustificada; ?>"></td>
        <td width="10%" align="center">&nbsp;</td>
        <td width="10%" align="center"><input name="txt_Exam[]" type="text" id="txt_Exam" size="5" maxlength="5" value="<?php echo $VTdtJustificada; ?>"></td>
        <td width="10%" align="center">&nbsp;</td>
        <td width="10%" align="center"><input name="txt_Equi20[]" type="text" id="txt_Exam" size="5" maxlength="5" value="<?php echo $VTdtAtraso; ?>"></td>
