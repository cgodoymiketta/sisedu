...
$Vtquery= " Select p.perapellidos, p.pernombres, p.percc, p.percodigo,
 ...
 pd.DTPRADICIONAL2, pd.DTPRADICIONAL1, pd.dtprrefuerzo, pd.dtprestado,
...
and qd.quicodigo=".$VLdtCamp6." and pd.prccodigo=".$VLdtCamp7." and ( pd.dtprestado=5 or pd.dtprestado=7 or pd.dtprestado=9 ) and qd.dtqmcodigo=pd.dtqmcodigo
order by p.perapellidos, p.pernombres";
	...
	{                           
?>                             
							<td width="20%" align="center" colspan="4" ><font size="-1" ><B><a href='doccorrecionparcial.php?vlccn=modificar&txt_Camp1=<?php echo $VLdtCamp1; ?>&txt_Camp2=<?php echo $VLdtCamp2; ?>&txt_Camp10=<?php echo $VLdtCamp10; ?>&txt_Camp6=<?php echo $VLdtCamp6; ?>&txt_Camp7=<?php echo $VLdtCamp7; ?>&txt_Camp8=<?php echo $VLdtCamp8; ?>&txt_Camp9=<?php echo $VLdtCamp9; ?>&txt_Camp11=<?php echo $VLdtCamp11; ?>&txt_Camp12=<?php echo $VLdtCamp12; ?>&txt_Camp14=<?php echo $VLdtCamp14; ?>&nlctv=<?php echo $VLAnoLocal; ?>&nsttcn=<?php echo $VLInstitucion; ?>&sr=<?php echo $VLUsuario; ?>' target=_parent >INSUMO1</a></B></font></td>
<?php } else { //////////////INSUMO 2  ?>                            
							<td width="10%" align="center" colspan="4"><font size="-1" ><B><a href='doccorrecionparcial.php?vlccn=modificar&txt_Camp1=<?php echo $VLdtCamp1; ?>&txt_Camp2=<?php echo $VLdtCamp2; ?>&txt_Camp10=<?php echo $VLdtCamp10; ?>&txt_Camp6=<?php echo $VLdtCamp6; ?>&txt_Camp7=<?php echo $VLdtCamp7; ?>&txt_Camp8=<?php echo $VLdtCamp8; ?>&txt_Camp9=<?php echo $VLdtCamp9; ?>&txt_Camp11=<?php echo $VLdtCamp11; ?>&txt_Camp12=<?php echo $VLdtCamp12; ?>&txt_Camp14=<?php echo $VLdtCamp14; ?>&nlctv=<?php echo $VLAnoLocal; ?>&nsttcn=<?php echo $VLInstitucion; ?>&sr=<?php echo $VLUsuario; ?>' target=_parent >INSUMO2</a></B></font></td> <?php } ?>
						  </tr>
                    
                          <tr>
<?php if ( $VLdtCamp13==1) {  //////// INSUMO 1 //////////// ?>                            
                          	<td>Tareas</td>
                            <td>Lecciones</td>
...
<?PHP 
	...
	if ( $VLnuDatos>0 )
	{
		for ( $i=0; $i< $VLnuDatos; $i++  )
		{
			...
			if ( $VtFamilia<4 ){  ///// SUPERIOR A 1 DE BASICA
			
?>						  

    <tr>
        <td width="40%"><font size="-1" ><? echo ($VTApellido." ".$VTNombre);  ?>
        <input type="hidden" name="txt_dtprcodigo[]" value="<?php echo $VTdtprcodigo; ?>"><input type="hidden" name="txt_dtprestado[]" value="<?php echo $VTdtprestado; ?>"><input type="hidden" name="txt_dtmattipo[]" value="<?php echo $VtMateriaTipo; ?>"></font></td>
<?php if ( $VLdtCamp13==1) { /////////// INSUMO 1  ?>                            
...
<?php  
			}else{  ////////// PRIMERO D BASICA PARA ABAJO
?>
    <tr>
        <td width="40%"><font size="-1" ><? echo ($VTApellido." ".$VTNombre);  ?>
        <input type="hidden" name="txt_dtprcodigo[]" value="<?php echo $VTdtprcodigo; ?>"><input type="hidden" name="txt_dtprestado[]" value="<?php echo $VTdtprestado; ?>"><input type="hidden" name="txt_dtmattipo[]" value="<?php echo $VtMateriaTipo; ?>"></font></td>
...
<?php	
	...
	<?php                          
	$Vtquery= " Select p.perapellidos, p.pernombres, p.percc, p.percodigo
	, pd.dtprcodigo, pd.dtprtareas, pd.dtpractindiv, pd.dtpractgrupal, pd.dtqmcodigo,
	 pd.dtprlecciones, pd.dtprprueba, pd.dtprpromedio1, pd.dtprpromedio , pd.dtprestado, 
	...
	?>                       
								...
								NOMINA</font></td>
								<td width="20%" align="center" colspan="4" ><font size="-1" ><B><a href='doccorrecionparcial.php?vlccn=modificar&txt_Camp1=<?php echo $VLdtCamp1; ?>&txt_Camp2=<?php echo $VLdtCamp2; ?>&txt_Camp10=<?php echo $VLdtCamp10; ?>&txt_Camp6=<?php echo $VLdtCamp6; ?>&txt_Camp7=<?php echo $VLdtCamp7; ?>&txt_Camp8=<?php echo $VLdtCamp8; ?>&txt_Camp9=<?php echo $VLdtCamp9; ?>&txt_Camp11=<?php echo $VLdtCamp11; ?>&txt_Camp12=<?php echo $VLdtCamp12; ?>&txt_Camp13=1&txt_Camp14=<?php echo $VLdtCamp14; ?>&nlctv=<?php echo $VLAnoLocal; ?>&nsttcn=<?php echo $VLInstitucion; ?>&sr=<?php echo $VLUsuario; ?>' target=_parent >INSUMO1</a></B></font></td>
								<td width="10%" align="center" colspan="3" ><font size="-1" ><B><a href='doccorrecionparcial.php?vlccn=modificar&txt_Camp1=<?php echo $VLdtCamp1; ?>&txt_Camp2=<?php echo $VLdtCamp2; ?>&txt_Camp13=2&txt_Camp14=<?php echo $VLdtCamp14; ?>&txt_Camp10=<?php echo $VLdtCamp10; ?>&txt_Camp6=<?php echo $VLdtCamp6; ?>&txt_Camp7=<?php echo $VLdtCamp7; ?>&txt_Camp8=<?php echo $VLdtCamp8; ?>&txt_Camp9=<?php echo $VLdtCamp9; ?>&txt_Camp11=<?php echo $VLdtCamp11; ?>&txt_Camp12=<?php echo $VLdtCamp12; ?>&nlctv=<?php echo $VLAnoLocal; ?>&nsttcn=<?php echo $VLInstitucion; ?>&sr=<?php echo $VLUsuario; ?>' target=_parent >INSUMO2</a></B></font></td>
	...
	<?PHP 
		...
		if ( $VLnuDatos>0 )
		{
			for ( $i=0; $i< $VLnuDatos; $i++  )
			{
				...
				$VLdtdtqmcodigo=get_result($VLdtDatos,$i,"pd.dtqmcodigo");
				$VTDtqmCodigo=$VLdtdtqmcodigo;
	
				if ( $VtFamilia<4 ){ ///// PARA INICIAL Y PRIMERO ////////////
				
	?>						  
	
		<tr>
			<td width="40%"><font size="-1" ><? echo ($VTApellido." ".$VTNombre);  ?>
			<input type="hidden" name="txt_dtdtqmcodigo[]" value="<?php echo $VLdtdtqmcodigo; ?>"><input type="hidden" name="txt_dtprcodigo[]" value="<?php echo $VTdtprcodigo; ?>"><input type="hidden" name="txt_dtprestado[]" value="<?php echo $VTdtprestado; ?>"><input type="hidden" name="txt_dtmattipo[]" value="<?php echo $VtMateriaTipo; ?>"></font></td>
			<td width="10%" align="center"> 
	...
	///////////////////////////////////////////////////////////////////
	///////////////// CORREGIR ESTE PASO Y PASARLO AL INICIO //////////
	///////////////////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////
				if ( $VLModificar!="")
				{
					...
					$VLdtprestado=$VTdtprestado+1;
					$Vtquery2.=", dtprestado=".$VLdtprestado;					
					$Vtquery2.=" where ( dtprestado>4 ) and ";
					...
					$VTQueryQuimestre="Select * from qmstrdtll where dtqmcodigo=".$VTDtqmCodigo;
					...
					if ( $VLnuDatosQuimestral>0)
					{
						...
						if($VTdtExamen>0) ///////  CONFIRMAMOS QUE SE INGRESARA EL EXAMEN PARA PODER ACTUALIZAR
						{
							...
							$VTQryParcial="Select * from prcldtll where dtqmcodigo=".$VTDtqmCodigo;
							...
							$QueryQActualizacion.=" , quipromquimestre=".$VTdtPromQuim." where dtqmcodigo=".$VTDtqmCodigo;
							$VtqueryModSum3.=" - ".$QueryQActualizacion;
			...
			<td width="10%" align="center"><font  <?php if($VTdtprpromedio<7 && $VTdtprpromedio>0 ) { ?> color="#FF0000" <?php } else { ?> color="#000000" <?php } ?> ><b><?php echo number_format($VTdtprpromedio,2); ?><?php //echo $VtqueryModSum3; ?> </b></font></td>
	...
	$Vtquery= " Select p.perapellidos, p.pernombres, p.percc, p.percodigo
	, pd.dtprcodigo, pd.dtprtareas, pd.dtpractindiv,pd.dtpractgrupal, 
	 pd.dtprlecciones, pd.dtprprueba, pd.dtprestado, pd.dtprpromedio 
	from mtrcl m, psn p, grp g, nsttcnstdnt n
	, prcldtll pd, qmstrdtll qd
	where p.percodigo=n.percodigo and n.inescodigo=m.inescodigo 
	and m.grucodigo=g.grucodigo and m.parcodigo=".$VLdtCamp8." and 
