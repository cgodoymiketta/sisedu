	...
	$Vtquery .=$VLQry2;
		...
		if ( $VLnuDatos>0 )
		{
			for ( $i=0; $i< $VLnuDatos; $i++  )
			{
			    ...
			    $VTTablaLista.="<tr>";
			    $VTTablaLista.="<tr>";
					$VTTablaLista.="<td width='50' ><font face='Times New Roman, Times, serif' size='2' color='#000000' ><a  href='distributivodocent.php?vlccn=modificar&txt_Camp1=".$VTCampo1."&txt_Camp9=".$VTCampo9."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=_parent >".$VTCampo1."</a></font></strong></td>";
				
				$VTTablaLista.="<td width='200' ><font face='Times New Roman, Times, serif' size='2' color='#000000' ><a  href='distributivodocent.php?vlccn=modificar&txt_Camp1=".$VTCampo1."&txt_Camp9=".$VTCampo9."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=_parent >".$VTCampo2." ".$VTCampo3."</a></font></strong></td>";
				$VTTablaLista.="<td width='150'><font face='Times New Roman, Times, serif' size='2' color='#000000' ><a  href='distributivodocent.php?vlccn=modificar&txt_Camp1=".$VTCampo1."&txt_Camp9=".$VTCampo9."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=_parent >".$VTCampo5."</a> </font></strong></td>";
				$VTTablaLista.="<td width='100'><font face='Times New Roman, Times, serif' size='2' color='#000000' ><a  href='distributivodocent.php?vlccn=modificar&txt_Camp1=".$VTCampo1."&txt_Camp9=".$VTCampo9."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=_parent >".$VTCampo6."</a> </font></strong></td>";
				$VTTablaLista.="<td width='200'><font face='Times New Roman, Times, serif' size='2' color='#000000' ><a  href='distributivodocent.php?vlccn=modificar&txt_Camp1=".$VTCampo1."&txt_Camp9=".$VTCampo9."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=_parent >".$VTCampo7."</a> </font></strong></td>";
				$VTTablaLista.="</tr>";
