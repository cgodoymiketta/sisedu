		...
		<td >
			<table width="100%" border="0">
				  <tr>
					...
					<td><input name="txt_Camp1" type="hidden" id="txt_Camp1" size="10" maxlength="9" readonly="1" value="<?=$VLdtCamp1; ?>"><?=$VLtxtCampo2. " ".$numero1; ?>:</td>
					...
					<td>
						<select name="critero2">
							<option value="Nuevos">Nuevos
							<option value="Promovidos" selected="selected">Promovidos
			  <?php 
			  /*
			  //	Familias
				$Vtqueryf = $VLQry14;
	...
	<tr>
		<td align="center">	
			<table  border="0">
			  ...
			  //	materias
				$Vtquerym = $VLQry15;
				$Vtqueryg = $VLQry18.$VLQry9.$VLQryCampo15."=".$VLdtCamp15;
