<table width="100%" border="0">
					  ...
					  <tr>
						<td width="85%"  align="left"><a href="repestudiantegeneral.php?vlccn=modificar&critero2=NUEVOS&txt_Camp1=3&nsttcn=<?php echo $VLInstitucion; ?>&sr=<?php echo $VLUsuario; ?>&nlctv=<?php echo $VLAnoLocal; ?>&txt_Camp4=1&txt_Camp11=11&consultar2.x=20&consultar2.y=15"><strong><font face="Times New Roman, Times, serif" size="2" color="#0000FF" > Estudiante</font></strong></a></td>
					  </tr>
					  <tr>
