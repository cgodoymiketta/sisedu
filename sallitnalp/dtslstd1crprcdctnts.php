...
AND dm.gpmdestado =1  ";
		...
		$Vtquery= "SELECT m.matcodigo, m.matdescripcion,m.mattipo, c.curdescripcion, p.pardescripcion, q.quidescripcion, pr.prcdescripcion, q.quicodigo, pr.prccodigo, p.parcodigo, pr.prcestado, pr.prcversion, c.curcodigo, e.espcodigo, e.espsiglas, e.esporden
FROM mtr m, crs c, prll p, qmstr q, prcl pr, dcntmtr d, grpprllmtrdcnt dm, grpmtr gm, qmstrdtll qm, grp g, spcldd e
WHERE d.matcodigo = m.matcodigo
AND d.indocodigo =".$VLdtCamp2."
AND d.matcodigo = qm.matcodigo
AND q.quicodigo = qm.quicodigo
...
AND dm.gpmdestado =1 ";
	...
	if ( $VLnuDatos>0 )
	{
		for ( $i=0; $i< $VLnuDatos; $i++  )
		{
			...
			$VTCampo11=get_result($VLdtDatos,$i,"pr.prcestado");
		  ...
		  $VTTablaLista.="<tr>";
			$VTTablaLista.="<td ><a href='docnotas.php?vlccn=modificar&txt_Camp1=".$VLdtCamp1."&txt_Camp2=".$VLdtCamp2."&txt_Camp10=".$VTCampo10."&txt_Camp6=".$VTCampo6."&txt_Camp7=".$VTCampo7."&txt_Camp8=".$VTCampo8."&txt_Camp9=".$VTCampo9."&txt_Camp11=".$VTCampo11."&txt_Camp12=".$VTCampo12."&txt_Camp14=".$VTCampo14."&txt_dtmattipo=".$VtMattipo."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >". utf8_encode($VTCampo1)."</font></strong></a></td>";
			$VTTablaLista.="<td ><a href='docnotas.php?vlccn=modificar&txt_Camp1=".$VLdtCamp1."&txt_Camp2=".$VLdtCamp2."&txt_Camp10=".$VTCampo10."&txt_Camp6=".$VTCampo6."&txt_Camp7=".$VTCampo7."&txt_Camp8=".$VTCampo8."&txt_Camp9=".$VTCampo9."&txt_Camp11=".$VTCampo11."&txt_Camp12=".$VTCampo12."&txt_Camp14=".$VTCampo14."&txt_dtmattipo=".$VtMattipo."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".utf8_encode($VTCampo13."-".$VTCampo2." ".$VTCampo3)."</font></strong></a></td>";
			$VTTablaLista.="<td ><a href='docnotas.php?vlccn=modificar&txt_Camp1=".$VLdtCamp1."&txt_Camp2=".$VLdtCamp2."&txt_Camp10=".$VTCampo10."&txt_Camp6=".$VTCampo6."&txt_Camp7=".$VTCampo7."&txt_Camp8=".$VTCampo8."&txt_Camp9=".$VTCampo9."&txt_Camp11=".$VTCampo11."&txt_Camp12=".$VTCampo12."&txt_Camp14=".$VTCampo14."&txt_dtmattipo=".$VtMattipo."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".utf8_encode($VTCampo4." / ".$VTCampo5)."</font></strong></a></td>";
		  $VTTablaLista.="</tr>";
		}
	} else {
