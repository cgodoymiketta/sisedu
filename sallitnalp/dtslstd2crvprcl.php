	...
	?>
 	...
 	<tr>
		<td ><table width="100%" border="0">
		  <tr>
    <td width="10%">&nbsp;</td>
    <td width="80%" align="center">CORRECCION DE PARCIALES POR MATERIA</td>
    <td width="10%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
ORDER by q.quiorden desc, p.prcorden desc, p.prcdescripcion, dq.matcodigo ";
	...
	if ( $VLnuDatosM>0 )
	{
		...
		for ( $i=0; $i< $VLnuDatosM; $i++  )
		{
		  ...
		  $VTTablaLista.="<tr>";
			$VTTablaLista.="<td width='15%'><a href='sallitnalp/corparcialmateria.php?vlccn=modificar&txt_Camp1=".$VLdtCamp7."&txt_Camp10=".$VTCampo1."&txt_Camp6=".$VTCampo3."&txt_Camp7=".$VTCampo5."&txt_Camp8=".$VTCampo9."&txt_Camp9=".$VTCampo7."&txt_Camp14=".$VTCampo14."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=new ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".($VTCampo8)." - ".$VTCampo10."</font></strong></a></td>";
			$VTTablaLista.="<td width='45%'><a href='sallitnalp/corparcialmateria.php?vlccn=modificar&txt_Camp1=".$VLdtCamp7."&txt_Camp10=".$VTCampo1."&txt_Camp6=".$VTCampo3."&txt_Camp7=".$VTCampo5."&txt_Camp8=".$VTCampo9."&txt_Camp9=".$VTCampo7."&txt_Camp14=".$VTCampo14."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=new ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".($VTCampo2)."</font></strong></a></td>";
			$VTTablaLista.="<td width='40%'><a href='sallitnalp/corparcialmateria.php?vlccn=modificar&txt_Camp1=".$VLdtCamp7."&txt_Camp10=".$VTCampo1."&txt_Camp6=".$VTCampo3."&txt_Camp7=".$VTCampo5."&txt_Camp8=".$VTCampo9."&txt_Camp9=".$VTCampo7."&txt_Camp14=".$VTCampo14."&nlctv=".$VLAnoLocal."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."' target=new ><font face='Times New Roman, Times, serif' size='2' color='#000000' >".($VTCampo4." / ".$VTCampo6)."</font></strong></a></td>";
		  $VTTablaLista.="</tr>";
		}
	} else {
