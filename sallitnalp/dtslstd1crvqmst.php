...
<?php } ?>
    ...
    <tr> <td colspan="3"> 		<?php
		...
		$Vtquery = "Select * from spcldd where inscodigo=".$VLInstitucion; 	////// CONSULTAMOS LA ESPECIALIDAD
		$Vtquery .=" order by espseccion, esporden, espdescripcion  ";
		$Vtquery2 = $VLQry6." order by curorden ";			////// COSNULTAMOS EL CURSO
		$Vtquery3 = $VLQry8.$VLQry9;	////// EL GRUPO
		$Vtquery3 .= $VLQryCampo11."=".$VLAnoLocal;
