...
case "guardar":
	...
	{
		$Vtquery = $VLQry1."'$VLdtCamp2','$VLdtCamp3','$VLdtCamp4','$VLdtCamp5','$VLInstitucion','$VLAnoLocal',1,'$VLdtCamp9')";
		//echo $Vtquery;
...
break 1; 
case "generar":
///////////////////   RECUPERAMOS TODAS MATRICULAS POR INSTITUCION, ANO, GRUPO Y MATERIA //////////////
...
<table width="100%" border="0">
	<tr>
	  <td ><?php include("mnuccnvicqmstr.php"); ?></td>
	</tr>
	  <tr>
		<td ><hr></td>
	  </tr>
	  <tr>
		...
		{
			include("dtslstd2vicqmstr.php"); 
		} else {
		 	include("dtslstd1vicqmstr.php"); 
		 }
		 ?></td>
	</tr>
</table>