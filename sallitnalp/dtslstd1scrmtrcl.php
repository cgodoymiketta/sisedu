					...
					for ( $i=0; $i< $VLnuDatos; $i++  )
					{
						...
						if ($VLnuDatos3==0)
						{
							...
							if ($activo=="no")
							{
								...
								$VTTablaLista.="<td width='80' ><a href='matricula.php?vlccn=modificar&critero2=NUEVOS&txt_Camp1=".$VTCampo1."&nsttcn=".$VLInstitucion."&sr=".$VLUsuario."&nlctv=".$VLAnoLocal."&txt_Camp4=".$VTCampo4."&txt_Camp11=".$VTCampo11."&consultar2.x=20&consultar2.y=15' target=_parent ><font face='Times New Roman, Times, serif' size='2' color='#000000' ><img src='imagenes/blog-post-accept_16x16-32.gif' alt='Si' width='16' height='16' border='0'></font></strong></a></td>";
							}
						}
					}
				}
