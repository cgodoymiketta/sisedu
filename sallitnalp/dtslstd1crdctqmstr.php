...
e.espcodigo, e.espsiglas, e.esporden, g.grucodigo
FROM qmstrdtll qd, qmstr q, mtr m, crs c, prll p, dcntmtr d,
 grp g, grpmtr gm, grpprllmtrdcnt md, spcldd e, mtrcl mt
WHERE 
