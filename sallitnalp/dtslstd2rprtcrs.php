<table width="100%" border="0">
	<?php 
		if ($vlccn=="reportes")
		{ 
			$VtqueryEsp="Select * from spcldd where espcodigo=".$VLdtCamp1;
			$VtqueryCur="Select * from crs where curcodigo=".$VLdtCamp4;
			$VLdtDatosEsp = execute_query($VtqueryEsp,$VLConexion);
			$VLdtDatosCur = execute_query($VtqueryCur,$VLConexion);
			
			$VTEspDescripcion=get_result($VLdtDatosEsp,0,"espdescripcion");
			$VTEspSiglas=get_result($VLdtDatosEsp,0,"espsiglas");
			$VTEspSeccion=get_result($VLdtDatosEsp,0,"espseccion");
			$VTCurDescripcion=get_result($VLdtDatosCur,0,"curdescripcion");
	?>
...
?>
  ...
  <tr>
    <td width="10%">&nbsp;</td>
    <td width="80%" align="center">REPORTES AGRUPADOS POR EL CURSO : <?php echo $VTEspSiglas." ".$VTEspSeccion."-".$VTCurDescripcion;?> </td>
    <td width="10%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<select name="dt1">
      ...
      <tr>
        <td><input type="submit" name="materia" id="materia" value="MATERIA" /></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td><input type="submit" name="docente" id="docente" value="DOCENTE" /></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
    </table></td>
