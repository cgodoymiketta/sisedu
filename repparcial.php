...
$VLQry17="fml";
$VLQry18="Select g.gmcodigo, m.matcodigo, m.famcodigo  from grp ga, grpmtr g, mtr m ";
$VLQry18.= " where g.matcodigo=m.matcodigo and ga.grucodigo=g.grucodigo ";
...
<head><title>Reportes/Calificación Parcial</title>
...
if($VLnuDatosU>0){
	include("sallitnalp/strctr1rprtprcl.php"); 
} else{
