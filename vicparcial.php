...
$VLQry8.=" q.quidescripcion, q.quiorden from qmstr q, prcl p where ";
...
$VLQry11= " order by q.quiorden, p.prcorden, p.prcseccion ";
...
<title>Pantalla de Administracion del Sistema - Parcial</title></head>
<body>
<?php 
...
if($VLnuDatosU>0){
	include("sallitnalp/strctr1vicprcl.php");
} else{
