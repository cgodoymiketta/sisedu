...
<table width="100%" border="0">
  ...
  <tr>
    <td align="center"><table width="90%" border="0">
      ...
      <tr>
        <td align="justify"  > <font face="Arial, Arial Narrow" size="-1" >De conformidad con lo prescrito en el Art. 197 del Reglamento General a la Ley Orgánica de educación Intercultural y demás normativas vigentes, certifica que el/la estudiante <b><?php echo ($VLdtApellido." ".$VLdtNombre)?></b>  del <b><?php echo ($VLdtCurso);?> " <?php echo ($VLdtParalelo); ?> "</b> Año de <b><?php echo ($VLdtEspecialidad); ?></b> obtuvo las siguientes calificaciones durante el presente año lectivo:</font></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
		...
		switch ($VTdtMatTipo)
		{
			...
			if($VLMatfamilia<4)
			{
				...
				if ($VTdtDecima >0 && $VTdtCentecima>=1)
				{
					...
					{
						$VTCadena.=" COMA ".$DECENAS[round($VTdtDecima2)].$UNIDADES[$VTdtCentecima];
					} else {
...
?>      <tr>
        ...
        <td align="center"><font face="Arial Narrow, Arial" size="-1" ><b><?php 
...
?></b></font></td>
  ...
  <tr>
    <td><table width="100%" border="0">
      ...
      <tr>
        <td>&nbsp;</td>
        <td align="center"><p>Msc. María Isabel Fajardo López</p>
          <p><font size="-1" face="Arial, Arial Narrow">RECTORA</font></p></td>
        <td>&nbsp;</td>
