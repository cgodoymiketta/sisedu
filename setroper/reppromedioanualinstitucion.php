  ...
  <tr>
    ...
    <?PHP
		...
		/// SI EXISTEN QUIMESTRES ANUALES EN ESTE AÑO
		{
			...
			$VTQry="SELECT e.esporden, e.espseccion, e.espdescripcion, c.curorden, c.curdescripcion, p.parorden, p.pardescripcion, q.quicodigo, AVG(q.quipromquimestre) promedio
...
group by e.esporden, e.espseccion, e.espdescripcion, c.curorden, c.curdescripcion, p.parorden, p.pardescripcion, q.quicodigo
ORDER BY e.espseccion, e.esporden,  e.espdescripcion, c.curorden, c.curdescripcion, p.parorden, p.pardescripcion";
