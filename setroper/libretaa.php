...
$Query="Select q.quicodigo, q.quidescripcion, q.quitipo 
...
if ( $VLnuDatos>0 )
{
	...
	$VLdtCamp1=get_result($VLdtDatos,0,"q.quicodigo");
}

$VLQryC="Select c.curdescripcion, c.curcodigo 
from mtrcl m, crs c, grp g 
where m.mtrno=".$VLdtCamp10." 
and m.anocodigo=".$VLAnoLocal."
and m.grucodigo=g.grucodigo 
and g.curcodigo=c.curcodigo";
$VLQryP="Select p.pardescripcion, p.parcodigo 
from mtrcl m , prll p
where m.mtrno=".$VLdtCamp10." 
and m.anocodigo=".$VLAnoLocal."
and p.inscodigo=".$VLInstitucion."
and m.parcodigo=p.parcodigo ";
...
{
	$VLdtCurso=get_result($VLdtDatosC,0,"c.curdescripcion");
	$VLdtCamp3=get_result($VLdtDatosC,0,"c.curcodigo");
	$VLdtParalelo=get_result($VLdtDatosP,0,"p.pardescripcion");
	$VLdtCamp4=get_result($VLdtDatosP,0,"p.parcodigo");
}
...
<tr>
  ...
  <tr>
    ...
    <td width="12">&nbsp;</td>
    <td width="270"><font size="-2" color="#006600" face="Arial Narrow, Arial" > <?php if($VLMatfamilia==8)
...
<tr>
  ...
  <tr>
    ...
    <td width="10">&nbsp;</td>
    <td width="234"><font size="-2" color="#006600" face="Arial Narrow, Arial" > <?php if($VLMatfamilia==8)
...
<tr>
            ...
            <td align="center"><table width="400" border="0">
              <tr>
                ...
                <td width="109">&nbsp;</td>
                <td width="32">&nbsp;</td>
                <td width="206" align="center"><font size="-1">DIRECTORA</font></td>
              </tr>
...
nsttcnstdnt e, mtrcl mt, grp g
where
m.matcodigo=qd.matcodigo
and q.quicodigo=qd.quicodigo
and mt.mtrno=".$VLdtCamp1."
and q.anocodigo=".$VLAnoLocal."
and q.inscodigo=".$VLInstitucion."
and e.anocodigo=".$VLAnoLocal."
...
/////////// CONSULTAMOS LAS CALIFICACIONES ////////////
		...
		for($i=0; $i<$VLnuDatosEst;$i++)
		{
			...
			$VtApellidos=get_result($VLdtDatosEst,$i,"p.perapellidos");
			$VtNombres=get_result($VLdtDatosEst,$i,"p.pernombres");
			$VtMtrno=get_result($VLdtDatosEst,$i,"mt.mtrno");
			$VTMtrestado=get_result($VLdtDatosEst,$i,"mt.mtrestado");
			$VTdtPromedio=0;
			$VTdtSumatoria=0;
...
<table width="800" border="0" >
  ...
  <tr>
    <td rowspan="3" align="center"><font size="-1" face="Arial Narrow, Arial"> No</font></td>
...
////////////////  CONSULTAMOS LAS CALIFICACIONES ///////////////////////////////	
	...
	{
		$VLdtNombreM=get_result($VLdtDatosEst,$i,"m.matdescripcion");
		$VLdtPrimerQ=get_result($VLdtDatosEst,$i,"qd.quipromquimestre");
		$VLdtSegundoQ=get_result($VLdtDatosEst,$i+1,"qd.quipromquimestre");
		$VLdtAnual=get_result($VLdtDatosEst,$i+2,"qd.quipromquimestre");
		$VLdtFJust=get_result($VLdtDatosEst,$i+2,"qd.quipromquimestre");
		$VLdtFInjust=get_result($VLdtDatosEst,$i+2,"qd.quiexamen");
		$VLdtTipoMat=get_result($VLdtDatosEst,$i,"m.mattipo");
		$VLMatfamilia=get_result($VLdtDatosEst,$i,"m.famcodigo");
...
?>
  ...
  <tr>
    ...
    <td align="center" colspan="5"><font size="-1" face="Arial Narrow, Arial">DIRECTORA</font></td>
  </tr>
    <tr>
    <td align="center" colspan="3"><font size="-1" face="Arial Narrow, Arial">&nbsp;</font></td>
    <td align="center" colspan="5"><font size="-1" face="Arial Narrow, Arial">&nbsp;</font></td>
